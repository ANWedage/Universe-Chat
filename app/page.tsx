...
export default function Home() {
  return (
    <div className="fixed inset-0 overflow-y-auto bg-gradient-to-br from-green-100 via-emerald-50 to-teal-100 dark:from-gray-900 dark:via-green-900 dark:to-emerald-900">
