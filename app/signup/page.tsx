...
export default function SignUp() {
  ...
  return (
    <div className="fixed inset-0 overflow-y-auto flex items-center justify-center bg-gradient-to-br from-gray-900 via-green-900 to-emerald-900 px-4 py-8">
      ...
      <div className="max-w-md w-full bg-gray-800 rounded-2xl shadow-2xl p-5">
        ...
        {!isConfigured && (
          <div className="mb-3 bg-yellow-900/30 border border-yellow-600 rounded-lg p-2">
        ...
        <form onSubmit={handleSignUp} className="space-y-3">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-3 py-2 text-sm rounded-lg border border-gray-600 focus:ring-2 focus:ring-green-500 focus:border-transparent bg-gray-700 text-white transition"
          ...
          <div>
            <label htmlFor="retypePassword" className="block text-xs font-medium text-gray-300 mb-1">
              Retype Password
            </label>
            <input
              id="retypePassword"
